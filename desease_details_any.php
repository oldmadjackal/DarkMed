...
header("Content-type: text/html; charset=windows-1251") ;
   ...
   $glb_script="Desease_details_any.php" ;
...
//--------------------------- Извлечение данных карточки заболевания
    ...
    if($res->num_rows==0) {
          FileLog("ERROR", "No such desease in DB : ".$id) ;
                            $db->close() ;
         ErrorMsg("Ошибка на сервере. Повторите попытку позже.<br>Детали: неизвестное заболевание") ;
                         return ;
    }
...
<title>DarkMed Desease registry details any-form</title>
...
?>
  ...
  function GoToView()
  {
    window.open("desease_view.php?Id="+i_id.innerHTML) ;
  } 
