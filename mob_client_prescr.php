...
header("Content-type: text/html; charset=windows-1251") ;
   ...
   $glb_script="Mob_Client_prescr.php" ;
...
//--------------------------- Формирование списка дополнительных страницы пациента
  ...
  {  
     for($i=0 ; $i<$res->num_rows ; $i++)
     {
		...
		$link_href="mob_client_prescr_view.php?Session=".$session."&Owner=".$user."&Page=".$fields[0] ;
...
<title>DarkMed-Mobile Client Prescriptions</title>
