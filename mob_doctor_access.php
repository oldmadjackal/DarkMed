...
header("Content-type: text/html; charset=windows-1251") ;
   ...
   $glb_script="Mob_doctor_access.php" ;
  ...
  if(isset($receiver))
  {
    ...
    if($res===false) {
     ...
     SuccessMsg() ;
          ...
          echo  "  location.assign('mob_doctors_list.php?Session=".$session."') ;	\n" ;
...
<!--
  ...
  function FirstField() 
  {
       ...
       i_template  =document.getElementById("Checkbox_template") ;
...
?>
  ...
  function AddNewPage(p_title, p_value, p_type, p_check)
  {
     ...
     var  i_text_new ;
       ...
       i_check_new       = i_template.cloneNode(true) ;
       i_check_new.hidden= false ;
...
<div class="inputF">
  ...
  <table width="100%">
    ...
    <tr>
      <td class="fieldC">
        ...
        <textarea cols=32 rows=5 wrap="soft" name="Invite" id="Invite"></textarea>
      </td>
    </tr>
    <tr>
  ...
  <ul class="menu" name="Pages" id="Pages">
	...
	<input type="checkbox" hidden style="transform: scale(4)" id="Checkbox_template">
